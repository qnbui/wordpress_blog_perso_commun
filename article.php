		...
		<main class='container'>
			...
			<div class='row'>
				<div class='col-lg-offset-1 col-lg-10 col-md-offset-1 col-md-10'>
					...
					Biltong tenderloin beef landjaeger shoulder ham venison. Alcatra bacon short loin tri-tip cupim biltong filet mignon jerky short ribs chicken. Frankfurter chuck ground round, boudin fatback turducken prosciutto chicken spare ribs leberkas shankle venison rump jowl. Ham hamburger meatloaf pork chop sausage pork belly short loin ball tip short ribs chuck doner turkey. Pancetta leberkas bresaola, landjaeger swine shankle jowl picanha shank short loin pastrami bacon strip steak frankfurter drumstick. Hamburger kevin tenderloin, short loin salami ball tip tri-tip bacon ham hock boudin.
					</p>
				</div>
			</div>
			</article>
